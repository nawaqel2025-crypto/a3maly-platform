...
export default function CreateReceiptVoucher() {
    ...
    try {
      ...
      await fetch("/api/journal", {
        ...
        body: JSON.stringify({
          date: form.date,
          description:
            form.description || `سند قبض من ${fromAcc.name} إلى ${toAcc.name}`,
          debitAccountId: toAcc.id,
          debitAccountName: `${toAcc.name} (${toAcc.code})`,
          creditAccountId: fromAcc.id,
          creditAccountName: `${fromAcc.name} (${fromAcc.code})`,
      ...
      alert("تم إنشاء سند القبض وقيد اليومية بنجاح");
      setForm({
        date: "",
        fromAccountId: "",
        toAccountId: "",
  ...
  return (
    <div className="p-6 space-y-6">
      <h1 className="text-2xl font-bold">إنشاء سند قبض</h1>
